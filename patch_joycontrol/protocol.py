...
class ControllerProtocol(BaseProtocol):
    def __init__(self, controller: Controller, spi_flash: FlashMemory = None, reconnect = False):
        ...
        self.delay_map = {
            ...
            0x30: 1/120, # this needs revising, but 120 seems too fast
...
# INTERNAL
    ...
    def _generate_input_report(self, mode=None):
        ...
        if mode == 0x3F:
            ...
            input_report.data[3] = 0x8E #set_misc()
    ...
    async def _writer(self):
        ...
        while self.transport:
            ...
            try:
                ...
                f_cnt += 1
                if SHOWFRAME_TIME and f_cnt % 6000 ==0:
                    new_t = time.time()
                    print(f'time for send 6000 packet frames, dt={new_t - old_t}')
                    old_t = new_t
